 ...
 * })
 */
export declare const getRequiredPrefund: <entryPointVersion extends "0.6" | "0.7">({ userOperation, entryPointVersion }: GetRequiredPrefundReturnType<entryPointVersion>) => bigint;
